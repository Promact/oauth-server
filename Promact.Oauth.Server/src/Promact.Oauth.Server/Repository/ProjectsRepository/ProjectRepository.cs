...
namespace Promact.Oauth.Server.Repository.ProjectsRepository
{
    public class ProjectRepository : IProjectRepository
    {
        ...
        public async Task<IEnumerable<ProjectAc>> GetAllProjects()
        {
            ...
            var projectAcs = new List<ProjectAc>();
                ...
                projects.ForEach(project =>
                {
                    ...
                    {
                        //teamLeader.FirstName = _stringConstant.JsonDeserializeObject().Project.FirstOrDefault(o => o.Key == "TeamLeaderNotAssign").Value; ;
                        teamLeader.FirstName=_appConstant.Project.FirstOrDefault(o => o.Key == "TeamLeaderNotAssign").Value; 
                        teamLeader.LastName = _appConstant.Project.FirstOrDefault(o => o.Key == "TeamLeaderNotAssign").Value;
                        teamLeader.Email = _appConstant.Project.FirstOrDefault(o => o.Key == "TeamLeaderNotAssign").Value;
                    }
                    ...
                    { UpdatedDate = Convert.ToDateTime(project.UpdatedDateTime).ToString(_appConstant.Project.FirstOrDefault(o => o.Key == "DateFormate").Value); }
                    ...
                    projectObject.CreatedDate = project.CreatedDateTime.ToString(_appConstant.Project.FirstOrDefault(o => o.Key == "DateFormate").Value).ToString();
        ...
        public async Task<List<UserRoleAc>> GetListOfEmployee(string name)
        {
            ...
            usersRole.Role = _appConstant.CommanStringConstant.FirstOrDefault(o => o.Key == "RoleTeamLeader").Value; ;
            ...
            foreach (var projectUser in projectUserList)
            {
                ...
                usersRoles.Role = _appConstant.CommanStringConstant.FirstOrDefault(o => o.Key == "RoleAdmin").Value;
        ...
        public async Task<List<UserRoleAc>> GetUserRole(string name)
        {
            ...
            if (userRole == _appConstant.CommanStringConstant.FirstOrDefault(o=>o.Key=="RoleAdmin").Value)
            {
                ...
                foreach (var userDetails in userList)
                {
                    ...
                    if (roles.Count() != 0 && roles[0] == _appConstant.CommanStringConstant.FirstOrDefault(o=>o.Key=="RoleEmployee").Value)
                    {
            ...
            else
            {
                ...
                if (project == null)
                {
                    var usersRole = new UserRoleAc();
                    usersRole.UserName = user.UserName;
                    usersRole.Role = _appConstant.CommanStringConstant.FirstOrDefault(o => o.Key == "RoleEmployee").Value;
                    usersRole.Name = user.FirstName + " " + user.LastName;
                    userRoles.Add(usersRole);
                }
                else
        ...
        public async Task<IList<ProjectAc>> GetProjectsWithUsers()
        {
            ...
            projects.ForEach(project =>
            {
                ...
                teamLead.Role = _appConstant.CommanStringConstant.FirstOrDefault(o => o.Key == "RoleTeamLeader").Value;
                ...
                projectObject.CreatedDate = project.CreatedDateTime.ToString(_appConstant.CommanStringConstant.FirstOrDefault(o => o.Key == "Format").Value);
                foreach (var projectUser in projectUsers)
                {
                    ...
                    proUser.Role = _appConstant.CommanStringConstant.FirstOrDefault(o=>o.Key== "RoleEmployee").Value;
        ...
        public async Task<ProjectAc> GetProjectDetails(int projectId)
        {
            ...
            projectDetails.CreatedDate = project.CreatedDateTime.ToString(_appConstant.CommanStringConstant.FirstOrDefault(o => o.Key == "Format").Value);
