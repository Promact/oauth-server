...
import * as import1 from '../../../app/users/user.module';
...
import * as import38 from '../../../app/users/user.service';
...
import * as import42 from './user.component.ngfactory';
import * as import43 from './user-list/user-list.component.ngfactory';
import * as import44 from './user-add/user-add.component.ngfactory';
import * as import45 from './user-edit/user-edit.component.ngfactory';
import * as import46 from './user-details/user-details.component.ngfactory';
import * as import47 from '@angular/core/src/i18n/tokens';
import * as import48 from '../../../app/users/user.component';
import * as import49 from '../../../app/users/user-list/user-list.component';
import * as import50 from '../../../app/users/user-add/user-add.component';
import * as import51 from '../../../app/users/user-edit/user-edit.component';
import * as import52 from '../../../app/users/user-details/user-details.component';
import * as import53 from '../../../app/http.service';
...
class UserModuleInjector extends import0.NgModuleInjector<import1.UserModule> {
  ...
  _UserModule_33:import1.UserModule;
  ...
  __ROUTES_37:any[];
  __UserService_38:import38.UserService;
  constructor(parent:import39.Injector) {
    super(parent,[
      import40.Md2ToastComponentNgFactory,
      import41.Md2TooltipComponentNgFactory,
      import42.UserComponentNgFactory,
      import43.UserListComponentNgFactory,
      import43.UserListComponentNgFactory,
      import44.UserAddComponentNgFactory,
      import45.UserEditComponentNgFactory,
      import46.UserDetailsComponentNgFactory
    ]
    ,([] as any[]));
  }
  get _NgLocalization_34():import35.NgLocaleLocalization {
    if ((this.__NgLocalization_34 == (null as any))) { (this.__NgLocalization_34 = new import35.NgLocaleLocalization(this.parent.get(import47.LOCALE_ID))); }
  ...
  get _ROUTES_37():any[] {
        if ((this.__ROUTES_37 == (null as any))) { (this.__ROUTES_37 = [[{
          path: 'user',
          component: import48.UserComponent,
          children: [
            {
              path: '',
              component: import49.UserListComponent
            }
            ,
            {
              path: 'list',
            ...
            {
              path: 'add',
              component: import50.UserAddComponent
            }
            ,
            {
              path: 'edit/:id',
              component: import51.UserEditComponent
            }
            ,
            {
              path: 'details/:id',
              component: import52.UserDetailsComponent
            }
  ...
  get _UserService_38():import38.UserService {
    if ((this.__UserService_38 == (null as any))) { (this.__UserService_38 = new import38.UserService(this.parent.get(import53.HttpService),this.parent.get(import53.HttpService))); }
    return this.__UserService_38;
  }
  createInternal():import1.UserModule {
    ...
    this._UserModule_33 = new import1.UserModule();
    return this._UserModule_33;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.UserModule)) { return this._UserModule_33; }
    ...
    if ((token === import54.ROUTES)) { return this._ROUTES_37; }
    if ((token === import38.UserService)) { return this._UserService_38; }
