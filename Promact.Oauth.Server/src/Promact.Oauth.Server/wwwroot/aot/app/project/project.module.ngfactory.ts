...
import * as import1 from '../../../app/project/project.module';
...
import * as import38 from '../../../app/project/project.service';
import * as import39 from '../../../app/login.service';
import * as import40 from '@angular/core/src/di/injector';
import * as import41 from '../../node_modules/md2/toast/toast.ngfactory';
import * as import42 from '../../node_modules/md2/tooltip/tooltip.ngfactory';
import * as import43 from './project.component.ngfactory';
import * as import44 from './project-list/project-list.component.ngfactory';
import * as import45 from './project-add/project-add.component.ngfactory';
import * as import46 from './project-edit/project-edit.component.ngfactory';
import * as import47 from './project-view/project-view.component.ngfactory';
import * as import48 from '@angular/core/src/i18n/tokens';
import * as import49 from '../../../app/project/project.component';
import * as import50 from '../../../app/project/project-list/project-list.component';
import * as import51 from '../../../app/project/project-add/project-add.component';
import * as import52 from '../../../app/project/project-edit/project-edit.component';
import * as import53 from '../../../app/project/project-view/project-view.component';
import * as import54 from '../../../app/http.service';
import * as import55 from '@angular/router/src/router_config_loader';
class ProjectModuleInjector extends import0.NgModuleInjector<import1.ProjectModule> {
  ...
  _ProjectModule_33:import1.ProjectModule;
  ...
  __ROUTES_37:any[];
  __ProjectService_38:import38.ProjectService;
  __LoginService_39:import39.LoginService;
  constructor(parent:import40.Injector) {
    super(parent,[
      import41.Md2ToastComponentNgFactory,
      import42.Md2TooltipComponentNgFactory,
      import43.ProjectComponentNgFactory,
      import44.ProjectListComponentNgFactory,
      import44.ProjectListComponentNgFactory,
      import45.ProjectAddComponentNgFactory,
      import46.ProjectEditComponentNgFactory,
      import47.ProjectViewComponentNgFactory
    ]
    ,([] as any[]));
  }
  get _NgLocalization_34():import35.NgLocaleLocalization {
    if ((this.__NgLocalization_34 == (null as any))) { (this.__NgLocalization_34 = new import35.NgLocaleLocalization(this.parent.get(import48.LOCALE_ID))); }
  ...
  get _ROUTES_37():any[] {
        if ((this.__ROUTES_37 == (null as any))) { (this.__ROUTES_37 = [[{
          path: 'project',
          component: import49.ProjectComponent,
          children: [
            {
              path: '',
              component: import50.ProjectListComponent
            }
            ,
            {
              path: 'list',
            ...
            {
              path: 'add',
              component: import51.ProjectAddComponent
            }
            ,
            {
              path: 'edit/:id',
              component: import52.ProjectEditComponent
            }
            ,
            {
              path: 'view/:id',
  ...
  get _ProjectService_38():import38.ProjectService {
    if ((this.__ProjectService_38 == (null as any))) { (this.__ProjectService_38 = new import38.ProjectService(this.parent.get(import54.HttpService))); }
    return this.__ProjectService_38;
  }
  get _LoginService_39():import39.LoginService {
    if ((this.__LoginService_39 == (null as any))) { (this.__LoginService_39 = new import39.LoginService(this.parent.get(import54.HttpService))); }
    return this.__LoginService_39;
  }
  createInternal():import1.ProjectModule {
    ...
    this._ProjectModule_33 = new import1.ProjectModule();
    return this._ProjectModule_33;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.ProjectModule)) { return this._ProjectModule_33; }
    ...
    if ((token === import55.ROUTES)) { return this._ROUTES_37; }
    if ((token === import38.ProjectService)) { return this._ProjectService_38; }
    if ((token === import39.LoginService)) { return this._LoginService_39; }
    return notFoundResult;
  }
  destroyInternal():void {
  }
}
export const ProjectModuleNgFactory:import0.NgModuleFactory<import1.ProjectModule> = new import0.NgModuleFactory(ProjectModuleInjector,import1.ProjectModule);