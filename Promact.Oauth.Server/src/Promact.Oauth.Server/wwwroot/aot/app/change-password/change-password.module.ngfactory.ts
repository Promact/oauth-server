...
import * as import1 from '../../../app/change-password/change-password.module';
...
import * as import42 from './changepassword.component.ngfactory';
import * as import43 from './change-password.component.ngfactory';
import * as import44 from '@angular/core/src/i18n/tokens';
import * as import45 from '../../../app/change-password/changepassword.component';
import * as import46 from '../../../app/change-password/change-password.component';
import * as import47 from '../../../app/http.service';
import * as import48 from '@angular/router/src/router_config_loader';
class ChangePasswordModuleInjector extends import0.NgModuleInjector<import1.ChangePasswordModule> {
  ...
  _ChangePasswordModule_33:import1.ChangePasswordModule;
  ...
  constructor(parent:import39.Injector) {
    super(parent,[
      ...
      import42.ChangePasswordMainComponentNgFactory,
      import43.ChangePasswordComponentNgFactory
    ]
    ,([] as any[]));
  }
  get _NgLocalization_34():import35.NgLocaleLocalization {
    if ((this.__NgLocalization_34 == (null as any))) { (this.__NgLocalization_34 = new import35.NgLocaleLocalization(this.parent.get(import44.LOCALE_ID))); }
  ...
  get _ROUTES_37():any[] {
        if ((this.__ROUTES_37 == (null as any))) { (this.__ROUTES_37 = [[{
          path: 'changepassword',
          component: import45.ChangePasswordMainComponent,
            children: [{
              path: '',
  ...
  get _UserService_38():import38.UserService {
    if ((this.__UserService_38 == (null as any))) { (this.__UserService_38 = new import38.UserService(this.parent.get(import47.HttpService),this.parent.get(import47.HttpService))); }
    return this.__UserService_38;
  }
  createInternal():import1.ChangePasswordModule {
    ...
    this._ChangePasswordModule_33 = new import1.ChangePasswordModule();
    return this._ChangePasswordModule_33;
  }
  getInternal(token:any,notFoundResult:any):any {
    ...
    if ((token === import1.ChangePasswordModule)) { return this._ChangePasswordModule_33; }
    ...
    if ((token === import48.ROUTES)) { return this._ROUTES_37; }
...
export const ChangePasswordModuleNgFactory:import0.NgModuleFactory<import1.ChangePasswordModule> = new import0.NgModuleFactory(ChangePasswordModuleInjector,import1.ChangePasswordModule);